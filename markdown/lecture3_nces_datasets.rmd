...
stata -b -q do ../do/lecture3_nces_datasets.do	 
```

```{r}
## save log file in object
lf <- 'lecture3_nces_datasets.log'
```
...
At the very least, your directory structure should have the following
subdirectories:
...
By having your main folder structured in this way, you can make use of
relative links between your files, e.g., `"../data/"`. Even if you
move the main directory somewhere else on your computer, your files
will still work as long as the internal structure stays the same.
