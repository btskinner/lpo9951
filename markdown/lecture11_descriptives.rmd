...
```
```{r, results = 'asis'}
writeLines(alignfigure('../plots/hist_bynels2m.png', 'center'))
```
<br>
...
```
```{r, results = 'asis'}
writeLines(alignfigure('../plots/spike_bynels2m.png', 'center'))
```
<br>
...
```
```{r, results = 'asis'}
writeLines(alignfigure('../plots/kd_bynels2m.png', 'center'))
writeLines(alignfigure('../plots/kd_bynels2m_cond.png', 'center'))
```
<br>
...
```{r, results = 'asis'}
writeLines(includetable('../tables/means_se.html', 'center'))
```
<br>
...
```{r, results = 'asis'}
writeLines(includetable('../tables/means_sd.html', 'center'))
```
...
```
```{r, results = 'asis'}
writeLines(alignfigure('../plots/bar_bystexp.png', 'center'))
```
...
```{r, results = 'asis'}
writeLines(includetable('../tables/proportions.html', 'center'))
```
<br>
...
```
```{r, results = 'asis'}
writeLines(alignfigure('../plots/sc_math_read.png', 'center'))
```
<br>
...
```
```{r, results = 'asis'}
writeLines(alignfigure('../plots/sc_math_read_10.png', 'center'))
```
<br>
...
```
```{r, results = 'asis'}
writeLines(alignfigure('../plots/sc_complex.png', 'center'))
```
...
```
```{r, results = 'asis'}
writeLines(alignfigure('../plots/sc_cond.png', 'center'))
```
<br>
...
```
```{r, results = 'asis'}
writeLines(alignfigure('../plots/matrix_plot.png', 'center'))
```
<br>
...
```
```{r, results = 'asis'}
writeLines(alignfigure('../plots/box1.png', 'center'))
writeLines(alignfigure('../plots/box2.png', 'center'))
```
<br>
...
```
```{r, results = 'asis'}
writeLines(alignfigure('../plots/dot_both.png', 'center'))
```
<br>
...
```
```{r, results = 'asis'}
writeLines(alignfigure('../plots/tabplot1.png', 'center'))
writeLines(alignfigure('../plots/tabplot2.png', 'center'))
```
...
```
```{r, results = 'asis'}
writeLines(alignfigure('../plots/jitterplot.png', 'center'))
```
...
```
```{r, results = 'asis'}
writeLines(alignfigure('../plots/heatmap.png', 'center'))
```
...
```
```{r, results = 'asis'}
writeLines(includetable('../tables/race_tab.html', 'center'))
```
<br><br>
