...
When you feel ready to share your image with the wider world (which
...
his or her own, but it will make sure that someone who simply
downloads your image or links to it will have cite you, if for no
other reason than your name is on it.

This goes without saying that you should similarly credit the work of
others, even if it's just found on the internet.

## Final word

Do you have to use git, LaTeX, markdown, etc. in order to be a good
researcher? No. If you do, are you thereby a good researcher? Not
necessarily. The point in introducing you to these various syntaxes and
techniques is not to say that "this is the **one** way to do research" but
rather to offer what might be a better way. Pick and choose from these
techniques and others as you need, but actively choose something. MS
Word and Dropbox may work fine...for now. Or maybe forever. But don't
let them be your default simply because you don't know anything else.
