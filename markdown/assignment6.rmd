...
each number. I'm being purposefully vague; just show you know how to use some of
the programming commands that we talked about:

1. Create a switch for loading your own data.
2. Use the programming code learned in class to recode for missing
   data and to otherwise clean your datasets. 
3. Use the programming code learned in class to deal with categorical variables.
