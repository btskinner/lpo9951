...
of students in the grade over the number selected, \( \frac{N_h}{n_h}
\), and use equation (6), but the \(N_h\) would cancel out and we
...
\(\Big(\frac{N_h}{N}\Big)^2\) and add them together.
