...
```{r, results = 'asis'}
writeLines(alignfigure('../plots/box_str.png', 'center'))
```
...
```{r, results = 'asis'}
writeLines(alignfigure('../plots/hist_str.png', 'center'))
```
<br>
...
```{r, results = 'asis'}
writeLines(alignfigure('../plots/sc_inc_meal.png', 'center'))
```
<br>
...
```{r, results = 'asis'}
writeLines(alignfigure('../plots/sc_str_str_two.png', 'center'))
```
...
```{r, results = 'asis'}
writeLines(alignfigure('../plots/sc_str_str_three.png', 'center'))
```
...
```{r, results = 'asis'}
writeLines(alignfigure('../plots/hist_read_scr.png', 'center'))
```
